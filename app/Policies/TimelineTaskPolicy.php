...
class TimelineTaskPolicy
{
     ...
     */
    public function restore(User $user, TimelineTask $timelineTask): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, TimelineTask $timelineTask): bool
    {
        return false;
    }
}
