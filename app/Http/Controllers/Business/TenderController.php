...
use App\Models\Business\MasterListItem;
use App\Models\User;
...
class TenderController extends Controller
{
    ...
    public function uploadFiles(Request $request, int $id): JsonResponse
    {
        ...
        $customCols = MasterListItem::where('category', 'project_document_title')->pluck('color')->toArray();
     ...
     */
    private function autoPopulateMasterList(Tender $tender): void
    {
        $fields = [
            'status'       => 'status',
            'type'         => 'type',
        ...
        foreach ($fields as $field => $category) {
            ...
            if ($value !== '') {
                ...
                $exists = MasterListItem::where('category', $category)
    ...
    public function requestVerification(Request $request, $id) {
        ...
        $notifiables = User::whereIn('role', ['business_admin'])->get();
        \Illuminate\Support\Facades\Notification::send($notifiables, new \App\Notifications\VerificationRequested([
            'message' => $message,
            'url' => $url,
            'id' => $model->id,
    ...
    public function check(Request $request, $id) {
        ...
        $gms = User::whereIn('role', ['business_higher_admin'])->get();
    ...
    public function verify(Request $request, $id) {
        ...
        $directors = User::whereIn('role', ['superadmin', 'admin'])->get();
